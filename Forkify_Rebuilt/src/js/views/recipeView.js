...
class RecipeView extends View {
  ...
  _errorMessage =
    "Could not find the recipe. Please try again with another recipe!";
      ...
      this._data.bookmarked === true ? "-fill" : ""
        ...
        <div class="recipe__ingredients">
          ...
          <ul class="recipe__ingredient-list">
            ${this._data.ingredients.map(this.#generateMarkup).join("")}
          </ul>
        </div>
    ...
    return `
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${
          recipe.quantity ? new Fraction(recipe.quantity).toString() : ""
        }</div>
